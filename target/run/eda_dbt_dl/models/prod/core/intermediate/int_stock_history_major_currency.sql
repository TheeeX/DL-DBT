      ...
      create or replace transient table PC_DBT_DB.dbt_zpaul_prod.int_stock_history_major_currency  as
      (with
stock_history as (
    select * from PC_DBT_DB.dbt_zpaul_prod.int_stock_history
),
 
fx_rates as (
    select * from PC_DBT_DB.dbt_zpaul_prod.int_fx_rates
),
